...
Primero que todo, debes asegurar las credentials necesarias para usar tu aws account. Guarda esas crendenciales en `.aws/credentials`. Una vez las tengas continua con los pasos posteriores.
